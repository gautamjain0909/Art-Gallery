...
Promise.all([
    (0, _utils.preloadImages)(".tiles__line-img"),
    (0, _utils.preloadFonts)("rmd7deq")
]).then(()=>{
...
/* locomotive-scroll v3.6.1 | MIT License | https://github.com/locomotivemtl/locomotive-scroll */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var global = arguments[3];
            ...
            value: function detectElements(hasCallEventSet) {
                ...
                this.els.forEach(function(el, i) {
                    if (el && (!el.inView || hasCallEventSet)) {
                        if (scrollBottom >= el.top && scrollTop < el.bottom) _this3.setInView(el, i);
                    }
                    if (el && el.inView) {
        ...
        },
        {
            ...
            value: function setInView(current, i) {
                ...
                if (!current.repeat && !current.speed && !current.sticky) {
                    if (!current.call || current.call && this.hasCallEventSet) this.els[i] = null;
                }
            }
        },
        {
            ...
            value: function setOutOfView(current, i) {
                if (current.repeat || current.speed !== undefined) this.els[i].inView = false;
    ...
    _createClass(_default, [
        ...
        },
        {
            ...
            value: function addSpeed() {
                if (window.pageYOffset != this.instance.scroll.y) this.instance.speed = (window.pageYOffset - this.instance.scroll.y) / (Date.now() - this.timestamp);
        ...
        },
        {
            ...
            value: function scrollTo(targetOption, offsetOption, duration, easing, disableLerp, callback) {
                ...
                if (typeof targetOption === "string") {
                    ...
                    if (targetOption === "top") target = this.html;
                    else if (targetOption === "bottom") target = this.html.offsetHeight - window.innerHeight;
                    else {
    ...
    _createClass(_default, [
                ...
                switch(e.keyCode){
                    ...
                    case keyCodes$1.SPACE:
                        if (!(document.activeElement instanceof HTMLInputElement) && !(document.activeElement instanceof HTMLTextAreaElement)) {
                            if (e.shiftKey) this.instance.delta.y -= window.innerHeight;
                            else this.instance.delta.y += window.innerHeight;
                        }
                        break;
                    default:
                        return;
        ...
        },
        {
            ...
            value: function checkScroll() {
                ...
                if (forced || this.isScrolling || this.isDraggingScrollbar) {
                    ...
                    if (!this.animatingScroll && (distance < 0.5 && this.instance.delta.y != 0 || distance < 0.5 && this.instance.delta.y == 0)) this.stopScrolling();
                    for(var i = this.sections.length - 1; i >= 0; i--)if (this.sections[i].persistent || this.instance.scroll.y > this.sections[i].offset && this.instance.scroll.y < this.sections[i].limit) {
        ...
        },
        {
            ...
            value: function updateScroll(e) {
                if (this.isScrolling || this.isDraggingScrollbar) this.instance.scroll.y = lerp(this.instance.scroll.y, this.instance.delta.y, this.lerp);
                else {
                    if (this.instance.scroll.y > this.instance.limit) this.setScroll(this.instance.scroll.x, this.instance.limit);
                    else if (this.instance.scroll.y < 0) this.setScroll(this.instance.scroll.x, 0);
                    else this.setScroll(this.instance.scroll.x, this.instance.delta.y);
                }
            }
        },
        {
        ...
        },
        {
            ...
            value: function initScrollBar() {
                ...
                if (this.instance.limit + this.windowHeight <= this.windowHeight) return;
            ...
            value: function moveScrollBar(e) {
                ...
                if (!this.isTicking && this.isDraggingScrollbar) {
                    requestAnimationFrame(function() {
                        ...
                        if (y > 0 && y < _this5.instance.limit) _this5.instance.delta.y = y;
                    });
                    this.isTicking = true;
                }
            ...
            value: function addElements() {
                ...
                this.sections.forEach(function(section, y) {
                    ...
                    els.forEach(function(el, id) {
                        ...
                        if (!_this6.sections[y].inView) top = targetEl.getBoundingClientRect().top - getTranslate(_this6.sections[y].el).y - getTranslate(targetEl).y;
                        else top = targetEl.getBoundingClientRect().top + _this6.instance.scroll.y - getTranslate(targetEl).y;
                        ...
                        if (speed !== false || sticky) _this6.parallaxElements.push(mappedEl);
                    });
                });
            }
        },
        ...
        },
        {
            ...
            value: function transformElements(isForced) {
                ...
                this.parallaxElements.forEach(function(current, i) {
                    ...
                    if (current.sticky) {
                        if (current.inView) transformDistance = _this8.instance.scroll.y - current.top + window.innerHeight;
                        else {
                    ...
                    if (transformDistance !== false) {
                        if (current.direction === "horizontal") _this8.transform(current.el, transformDistance, 0, isForced ? false : current.delay);
        ...
        },
        {
            ...
            value: function scrollTo(targetOption, offsetOption) {
                ...
                if (typeof targetOption === "string") {
                    // Selector or boundaries
                    if (targetOption === "top") target = 0;
                    else if (targetOption === "bottom") target = this.instance.limit;
                    else {
                        target = document.querySelector(targetOption); // If the query fails, abort
                        if (!target) return;
                    }
                ...
                if (typeof target !== "number") {
                    ...
                    if (parentSection) parentSectionOffset = getTranslate(parentSection).y; // We got a parent section, store it's current offset to remove it later
    ...
    _createClass(_default, [
        {
            key: "init",
            value: function init() {
                if (!this.smoothMobile) this.isMobile = /Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1;
                if (this.smooth === true && !this.isMobile) this.scroll = new _default$2(this.options);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l9Mez","ebWYT"], "ebWYT", "parcelRequiref78b")
